...
<PageComponent>
 <template v-slot:header>
     <div class="flex items-center justify-between">
        ...
        <button
        v-if="route.params.id" type="button" @click="deleteSurvey()" class="py-2 px-3 text-white bg-red-500 rounded-md hover:bg-red-600"
        >
    ...
    <div class="shadow sm:rounded-md sm:overflow-hidden">
        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>
                ...
                <div class="mt-1 flex  items-center">
                    ...
                    <span v-else class="flex items-center justify-center h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-[80%] w-[80%] text-gray-300" fill="currentColor" viewBox="0 0 24 24" >
            ...
            <div>
                ...
                <textarea  name="description" id="description" v-model="model.description" rows="3" autocomplete="survey_description" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Describe your survey" />
            </div>
                <!-- Expire Date -->
            <div>
            ...
            <div class="flex items-start">
                <div class="flex items-center h-5 ">
                    <input id="status"  type="checkbox" name="status" v-model="model.status" class="focus:ring-indigo-500 h-4 w-4 text-indigo-500 border-gray-300 rounded">
                </div>
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    <button type="submit" class="incline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500  "> 
                        Save
                    </button>
            </div>
...
function onImageChoose(ev)
{
    ...
    reader.onload = () => {
        //the field to send on backend and apply vaildations
