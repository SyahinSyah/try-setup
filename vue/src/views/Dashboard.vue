<template>
   <PageComponent title="Dashboard"> 
     ...
     <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
        <div class="bg-white shadow-md p-3 text-center flex flex-col order-1  lg:order-2" style="animation-delay: 0.1s">
          <h3 class="text-2xl font-semibold">Total Surveys</h3>
          <div class="text-8xl font-semibold flex-1 flex items-center justify-center">
            {{data.totalSurveys}}
          </div>
        </div>
        <div class="bg-white shadow-md p-3 text-center flex flex-col order-2 lg:order-4 animate-face-in-down" 
        ...
        <div class="row-span-2 oorder-3 bg-white shadow-md p-4 lg:order-1 animate-face-in-down"
        >
            <h3 class="text-2xl font-semibold">
                Latest Surveys:
              </h3>
             ...
             <div class="flex justify-between text-sm mb-3">
              ...
              <div class="flex justify-between">
                ...
                class="flex py-2 px-4 border border-transparent text-sm rounded-md text-indigo-500 hover:bg-indigo-700 
        ...
        <div class="row-span-2 order-4 bg-white shadow-md p-3 lg:order-3 animate-face-in-down" style="animation-delay: 0.3s">
          ...
          <a href="#" v-for="answer of data.latestAnswers" :key="answer.id" class="block hover:bg-gray-100/90">
            <div class="font-semibold">
              {{answer.survey.title}}
            </div>
            <small class="font-semibold">Answer Made at: 
              <i>{{answer.end_date}}</i>
            </small>
          </a>
        </div>
